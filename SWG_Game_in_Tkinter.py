...
def Complete_game():
    def main_Window():
        ...
        snakebutton = Checkbutton(text="Snake", variable=snake, bg="#32ADCF", font="timesnewroman 8 bold").pack(
            side=TOP,
            anchor=W,
            padx=1,
            pady=1)
        waterbutton = Checkbutton(text="Water", variable=water, bg="#32ADCF", font="timesnewroman 8 bold").pack(
            side=TOP,
            anchor=W,
            padx=1,
            pady=1)
        gunbutton = Checkbutton(text="Gun", variable=gun, bg="#32ADCF", font="timesnewroman 8 bold").pack(side=TOP,
                                                                                                          anchor=W,
                                                                                                          padx=1,
                                                                                                          pady=1)
        buttonframe.pack()
        game_main_buttons = Button(root, text="GO!!!!", borderwidth=2, relief=GROOVE, bg="#32ADCF",
                                   command=game_function_handler)
        ...
        # Status for result
        Label(root, font="timesnewroman 8 italic", anchor="e", bg="#32ADCF", textvariable=status_userscore).pack(
            fill=X, side=BOTTOM)
        Label(root, font="timesnewroman 8 italic", anchor="e", bg="#32ADCF", textvariable=status_computerscore).pack(
            fill=X, side=BOTTOM)
        Label(root, font="timesnewroman 8 italic", anchor="e", bg="#32ADCF", textvariable=status_noofdraws).pack(
            fill=X, side=BOTTOM)
        root.mainloop()
    ...
    game_main_button = Button(roots, text="OK", borderwidth=2, relief=GROOVE, bg="#32ADCF", padx=20,
                              command=main_Window)
